        ...
        works: [
            {
                ...
                discription: {
                    ...
                    ua: "Ця кумедна іграшка дозволяє переміщати кубик у контейнері за допомогою стрілок на клавіатурі. На жаль, сенсорний екран тут безпорадний. Кубик, може рухатися, стрибати і присідати. Коли кубик вдаряється об стіну, він трясе контейнер. Ви також можете розтягувати контейнер.  Для цього потрібно натиснути на правий нижній кут і, утримуючи його, змінюйте розмір. Дивіться спливаючі підказки. 😉",
                },
...

            {
                title: {
                    ...
                    ua: "Форма із кастомними елементами ",
                },
                discription: {
