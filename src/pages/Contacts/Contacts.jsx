...
const Contacts = () => {
    return (
        <div className={`page ${cl.pageContacts}`}>
            ...
            <h1 className={cl.pageContacts__content_headline}>My contacts</h1>
            <article className={cl.article}>
                <ul className={cl.mainInfo}>
                    <li className={cl.mainInfo_item}>
                        ...
                        <span className={cl.mainInfo_item_text}>Oleksandr Porubinovskyi</span>
                    </li>
                    <li className={cl.mainInfo_item}>
                        <span className={cl.mainInfo_item_title}>
                        ...
                        <span className={cl.mainInfo_item_text}>Kyiv, Ukraine</span>
                    </li>
                    <li className={cl.mainInfo_item}>
                        <span className={cl.mainInfo_item_title}>
